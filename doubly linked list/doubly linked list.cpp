...
public:
	...
	void Del(int pos = 0);
	void DelRange(int pos1 = 0, int pos2 = 0);
...
void List::DelRange(int pos1, int pos2)
{
	if (pos1 == 0)
	{
		cout << "Input position: pos1 ";
		cin >> pos1;
	}
	if (pos2 == 0 || pos2 < pos1)
	{
		cout << "Input position: pos2 ";
		cin >> pos2;
	}
	if (pos1 < 1 || pos1 > pos2 || pos2 > Count)
	{
		//Неверная позиция
		cout << "Incorrect position !!!\n";
		return;
...
/*
 Отличие двусвязного списка от односвязного состоит в том, что в двусвязном (или
двунаправленном списке) узел состоит не из двух, а из трех частей.
